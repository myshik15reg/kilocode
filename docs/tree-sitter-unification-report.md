...
- исходники грамматики 1С находятся в [`tree-sitter-grammars/`](../tree-sitter-grammars/README.md)
...
## Примечания по документированию

- Формулировка авторства 1С-изменений зафиксирована как: **«Автор изменений по 1С: Kilocode Team»**.
- Связанные материалы: оценка RLM для Kilo Code — [`rlm-evaluation`](../.protocols/2026-01-24-rlm-evaluation/brief.md).
