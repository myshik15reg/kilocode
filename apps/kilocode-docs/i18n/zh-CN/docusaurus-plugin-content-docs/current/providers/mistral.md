...
# 在 AlfaCode assistant 中使用 Mistral AI

AlfaCode assistant 支持通过 Mistral AI API 访问模型，包括标准 Mistral 模型和代码专用 Codestral 模型。
...
AlfaCode assistant 支持以下 Mistral 模型：
...
AlfaCode assistant中的默认模型温度为0.0，因此您应该考虑尝试[调整温度](/features/model-temperature)！
