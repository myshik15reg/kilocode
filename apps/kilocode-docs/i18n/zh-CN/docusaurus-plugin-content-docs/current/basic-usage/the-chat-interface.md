...
# 与 AlfaCode assistant 聊天

:::tip

**总结：** AlfaCode assistant 是一个 AI 编码助手，它存在于 VS Code 中。您可以用简单的英语与它聊天，它会为您编写、编辑和解释代码。

:::

## 快速设置

在 VS Code 的主侧边栏中找到 AlfaCode assistant 图标（<img src="/docs/img/kilo-v1.svg" width="12" />）。单击它以打开聊天面板。

**找不到面板？** 转到“视图”>“打开视图...”并搜索“AlfaCode assistant”

## 如何与 AlfaCode assistant 对话

**关键见解：** 只需用普通英语输入您想要的内容。无需特殊命令。

<Image src="/docs/img/typing-your-requests/typing-your-requests.png" alt="在 AlfaCode assistant 中输入请求的示例" width="600" />
...
**重要的原因：** 当您像与需要明确指导的聪明队友交谈一样进行交流时，AlfaCode assistant 的效果最佳。
