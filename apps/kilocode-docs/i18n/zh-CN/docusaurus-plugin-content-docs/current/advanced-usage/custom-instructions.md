...
自定义指令允许你个性化 AlfaCode assistant 的行为，提供特定的指导来塑造响应、编码风格和决策过程。
...
<img src="/docs/img/custom-instructions/custom-instructions.png" alt="AlfaCode assistant 提示标签显示全局自定义指令界面" width="600" />
1.  **打开提示标签：** 点击 AlfaCode assistant 顶部菜单栏中的 <Codicon name="notebook" /> 图标
...
模式特定指令可以使用提示标签设置
    ...
    <img src="/docs/img/custom-instructions/custom-instructions-3.png" alt="AlfaCode assistant 提示标签显示模式特定自定义指令界面" width="600" />
    * **打开标签：** 点击 AlfaCode assistant 顶部菜单栏中的 <Codicon name="notebook" /> 图标
