...
1. **Fork 并克隆仓库**：
    ...
    - **Fork 仓库**：
        - 访问 [AlfaCode assistant GitHub 仓库](https://github.com/Kilo-Org/kilocode)
...
2. 这将打开一个新的 VSCode 窗口，并加载 AlfaCode assistant
...
AlfaCode assistant 使用多种测试来确保质量：
...
- 检查 VSCode 中的输出面板（View > Output）并从下拉菜单中选择 "AlfaCode assistant"
