...
AlfaCode assistant 提供复杂的浏览器自动化功能，让您可以直接从 VS Code 与网站交互。此功能支持测试 Web 应用程序、自动化浏览器任务和捕获屏幕截图，而无需离开您的开发环境。

:::info 需要模型支持
AlfaCode assistant 中的浏览器使用需要使用高级智能体模型，并且仅在 Claude Sonnet 3.5、3.7 和 4 上进行过测试。
:::

## 浏览器使用工作原理

默认情况下，AlfaCode assistant 使用内置浏览器，该浏览器：
...
**目的**：确定 AlfaCode assistant 使用的浏览器会话的分辨率。
