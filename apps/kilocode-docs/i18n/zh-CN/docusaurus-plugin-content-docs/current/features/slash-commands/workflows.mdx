...
Workflows 通过为 AlfaCode assistant 定义分步指令来自动化重复性任务。通过在聊天中键入 `/[workflow-name.md]` 来调用任何工作流。

<img src="/docs/img/slash-commands/workflows.png" alt="AlfaCode assistant 中的工作流选项卡" width="600" />
...
现在您可以通过在聊天中键入 `/submit-pr.md` 来触发此工作流。AlfaCode assistant 将：
