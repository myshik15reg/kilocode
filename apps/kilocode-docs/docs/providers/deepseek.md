...
# Using DeepSeek With AlfaCode assistant

AlfaCode assistant supports accessing models through the DeepSeek API, including `deepseek-chat` and `deepseek-reasoner`.
