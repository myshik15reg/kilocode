...
## Why AlfaCode assistant Uses MCP

AlfaCode assistant leverages MCP to provide:
...
MCP creates a universal connector between AlfaCode assistant and external services, with REST APIs often powering those services behind the scenes.
