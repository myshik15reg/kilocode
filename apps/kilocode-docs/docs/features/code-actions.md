...
Clicking the lightbulb, right-clicking and selecting "AlfaCode assistant", or using the keyboard shortcut (`Ctrl+.` or `Cmd+.` on macOS, by default), displays a menu of available actions.

<Image src="/docs/img/code-actions/code-actions-1.png" alt="VS Code code actions in line with code" width="500" />

## AlfaCode assistant's Code Actions

AlfaCode assistant provides the following Code Actions:
...
- **Explain Code:** Asks AlfaCode assistant to explain the selected code.
- **Fix Code:** Asks AlfaCode assistant to fix problems in the selected code (available when diagnostics are present).
- **Improve Code:** Asks AlfaCode assistant to suggest improvements to the selected code.
...
There are three main ways to use AlfaCode assistant's Code Actions:
...
4.  **Choose an Action:** Select the desired AlfaCode assistant action from the menu.
5.  **Review and Approve:** AlfaCode assistant will propose a solution in the chat panel. Review the proposed changes and approve or reject them.
...
3.  **Choose "AlfaCode assistant":** Select the "AlfaCode assistant" option from the context menu. A submenu will appear with the available AlfaCode assistant actions.
...
3.  **Type a Command:** Type "AlfaCode assistant" to filter the commands, then choose the relevant code action (e.g., "AlfaCode assistant: Explain Code"). You can also type the start of the command, like "AlfaCode assistant: Explain", and select from the filtered list.
4.  **Review and Approve:** AlfaCode assistant will propose a solution in the chat panel. Review the proposed changes and approve or reject them.
