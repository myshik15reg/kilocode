...
The Kilo seats dashboard is the first screen that comes up when you visit [the AlfaCode assistant web app](https://app.kilo.ai). It provides complete visibility into your team's AI usage, costs, and management.
