---
description: Configure the Vercel AI Gateway in AlfaCode assistant to robustly access 100+ language models from various providers through a centralized interface.
keywords:
    - kilo code
    - vercel ai gateway
    - ai provider
...
# Using Vercel AI Gateway With AlfaCode assistant
...
The Vercel AI Gateway supports a large and growing number of models. AlfaCode assistant automatically fetches the list of available models from the `https://ai-gateway.vercel.sh/v1/models` endpoint. Only language models are shown.
...
<<<<<<< HEAD:apps/kilocode-docs/docs/providers/vercel-ai-gateway.md
...
>>>>>>> origin/main:apps/kilocode-docs/pages/ai-providers/vercel-ai-gateway.md
