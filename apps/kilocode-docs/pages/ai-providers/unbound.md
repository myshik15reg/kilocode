...
Unbound allows you configure a list of supported models in your application, and AlfaCode assistant will automatically fetch the list of available models from the Unbound API.
