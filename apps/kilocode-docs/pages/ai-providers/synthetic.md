...
# Using Synthetic With AlfaCode assistant

Synthetic provides access to several AI models running on secure infrastructure within the US and EU. They offer both subscription-based and usage-based pricing options, with strong privacy guarantees - they never train on your data and auto-delete API data within 14 days.
...
AlfaCode assistant supports all "always on" Synthetic AI models. The available models include various options optimized for different use cases.
