...
<<<<<<< HEAD:apps/kilocode-docs/docs/features/fast-edits.md
...
{% /callout %}
>>>>>>> origin/main:apps/kilocode-docs/pages/code-with-ai/features/fast-edits.md
...
<<<<<<< HEAD:apps/kilocode-docs/docs/features/fast-edits.md
    <img src="/docs/img/fast-edits/fast-edits-5.png" alt="AlfaCode assistant settings showing Enable editing through diffs" width="500" />
=======
...
<<<<<<< HEAD:apps/kilocode-docs/docs/features/fast-edits.md
    <img src="/docs/img/fast-edits/fast-edits-4.png" alt="AlfaCode assistant settings showing Enable editing through diffs checkbox and Match precision slider" width="500" />
=======
