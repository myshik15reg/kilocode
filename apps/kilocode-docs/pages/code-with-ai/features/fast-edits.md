---
title: "Fast Edits"
description: "Quick inline code edits with AlfaCode assistant"
---

# Fast Edits

{% callout type="info" title="Default Setting" %}
Fast Edits (using the "Enable editing through diffs" setting) is enabled by default in AlfaCode assistant. You typically don't need to change these settings unless you encounter specific issues or want to experiment with different diff strategies.
{% /callout %}

AlfaCode assistant offers an advanced setting to change how it edits files, using diffs (differences) instead of rewriting entire files. Enabling this feature provides significant benefits.
...
{% image src="/docs/img/fast-edits/fast-edits-5.png" alt="AlfaCode assistant settings showing Enable editing through diffs" width="500" /%}

1.  **Faster File Editing**: AlfaCode assistant modifies files more quickly by applying only the necessary changes.
...
{% image src="/docs/img/fast-edits/fast-edits-4.png" alt="AlfaCode assistant settings showing Enable editing through diffs checkbox and Match precision slider" width="500" /%}
