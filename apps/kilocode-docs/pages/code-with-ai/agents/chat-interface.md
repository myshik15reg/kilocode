...
description: "Learn how to use the AlfaCode assistant chat interface effectively"
---
...
Find the AlfaCode assistant icon ({% kiloCodeIcon /%}) in VS Code's Primary Side Bar. Click it to open the chat panel.
...
{% image src="/docs/img/typing-your-requests/typing-your-requests.png" alt="Example of typing a request in AlfaCode assistant" width="800" caption="Example of typing a request in AlfaCode assistant" /%}
...
- **Action buttons** - Approve or reject AlfaCode assistant's proposed changes
- **Plus button** - Start a new task session
- **Mode selector** - Choose how AlfaCode assistant should approach your task
...
- Spinning → AlfaCode assistant is working
- Red → Error occurred
- Green → Success
...
| Assuming AlfaCode assistant knows context | Use `@` to reference specific files                                                 |
