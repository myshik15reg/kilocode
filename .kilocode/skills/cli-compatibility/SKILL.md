...
> Обеспечение совместимости WorkFlowAI с различными CLI инструментами (Claude Code CLI, Aider, etc.)

## Triggers

- Работа с проектом через CLI вместо Kilo Code
...
## Kilo Code vs CLI Differences

### Feature Comparison

| Feature           | Kilo Code          | Claude Code CLI | Aider       |
| ----------------- | ------------------ | --------------- | ----------- |
...
| Kilo Code Mode | CLI Role    | Responsibilities                 |
| -------------- | ----------- | -------------------------------- |
...
## Quality Gates (Same as Kilo Code)
