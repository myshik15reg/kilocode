...
```
.kilocode/skills/defer/scripts/defer.py
```
...
```bash
python .kilocode/skills/defer/scripts/defer.py create \
...
```bash
python .kilocode/skills/defer/scripts/defer.py link-finding \
...
python .kilocode/skills/defer/scripts/defer.py list --status open
python .kilocode/skills/defer/scripts/defer.py list --type bug --area bot
python .kilocode/skills/defer/scripts/defer.py list --priority p1

# Generate a view (saved dashboard grouped by a field)
python .kilocode/skills/defer/scripts/defer.py view --group-by priority -o .backlog/views/by-priority.md
python .kilocode/skills/defer/scripts/defer.py view --group-by area -o .backlog/views/by-area.md
python .kilocode/skills/defer/scripts/defer.py view --group-by type -o .backlog/views/by-type.md

# Filtered view (e.g. only batch items grouped by type)
python .kilocode/skills/defer/scripts/defer.py view --group-by type --area batch

# Close and archive a resolved item
python .kilocode/skills/defer/scripts/defer.py close <slug>

# Bootstrap .backlog/ without creating an item
python .kilocode/skills/defer/scripts/defer.py bootstrap
```
