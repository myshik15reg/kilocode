...
4. **Обновление Memory Bank:** После каждой завершенной подзадачи субагента обновлять Memory Bank (минимум `context.md`) и фиксировать это в протоколе.
...
- [ ] Результаты собраны
- [ ] Memory Bank обновлен после каждой завершенной подзадачи субагента
