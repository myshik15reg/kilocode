...
- `1c-quality-specialist` MUST use [`1c-review-pack`](../1c-review-pack/SKILL.md:1) for retrieval-first review.
- Review artifacts MUST include `.protocols/.../artifacts/review/findings.json` in addition to markdown verdict files.
- Vendored review corpus path: `.kilocode/vendor/1c-ai-code-reviewers-rulles/`.
