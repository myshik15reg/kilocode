...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/workflowai-doctor.ps1 -ProjectPath .
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/workflowai-guardrails.ps1 -ProjectPath .
```
