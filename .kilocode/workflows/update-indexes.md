...
- [`plan.md`](plan.md) - Декомпозиция задачи на шаги (список задач)
...
- [`cli-master/`](cli-master/) - навык работы с CLI и безопасные команды
- [`git-workflow/`](git-workflow/) - git-воркфлоу и практики репозитория
- [`project-tests/`](project-tests/) - стратегия тестирования и запуск тестов
```
...
- [`brief.md`](brief.md) - цели, ограничения, DoD
- [`product.md`](product.md) - пользователи, ценность, UX
- [`architecture.md`](architecture.md) - архитектурные решения
- [`tech.md`](tech.md) - стек и инструменты
- [`context.md`](context.md) - текущий фокус и следующие шаги
```
