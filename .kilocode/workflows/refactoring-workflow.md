...
- Protocol is mandatory: every repo refactoring runs through `.protocols/YYYY-MM-DD-name/`.
...
4. Record progress in the protocol.
...
- [ ] Coverage is 100% (lines/branches/functions) or a waiver is approved before merge.
