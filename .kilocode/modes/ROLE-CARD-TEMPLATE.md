...
| Tool/Action    | Notes                               |
| -------------- | ----------------------------------- |
| repo-read      | [Любые файлы / только определённые] |
| repo-write     | [В каких случаях]                   |
| shell-commands | [Какие команды разрешены]           |
...
| Tool/Action | Notes |
|-------------|-------|
| repo-read | Любые файлы |
| shell-commands | Диагностические команды, запуск для воспроизведения |
| repo-write | Только для добавления debug logging |
