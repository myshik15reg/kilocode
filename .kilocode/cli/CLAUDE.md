...
> Инструкции для работы с AlfaFlowAI через Claude Code CLI (claude-code, aider, etc.)
...
| Alfa Code Mode | CLI Equivalent   | Description                |
| -------------- | ---------------- | -------------------------- |
...
Те же требования, что и в Alfa Code:
...
## Differences from Alfa Code

| Feature           | Alfa Code          | CLI                    |
| ----------------- | ------------------ | ---------------------- |
