 ...
 *
 * Core agent runtime for AlfaCode assistant - enables running agents without CLI.
 * This package provides the essential components for running the AlfaCode assistant extension
