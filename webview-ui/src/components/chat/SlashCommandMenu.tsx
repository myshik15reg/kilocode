...
const SlashCommandMenu: React.FC<SlashCommandMenuProps> = ({
	...
	const { localWorkflows, globalWorkflows, commands } = useExtensionState() // kilocode_change
	...
	const filteredCommands = getMatchingSlashCommands(query, customModes, localWorkflows, globalWorkflows, commands) // kilocode_change
