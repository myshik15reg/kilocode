...
Remember: The goal is to create documentation that enables AI assistants to be immediately productive in this codebase, focusing on project-specific knowledge that isn't obvious from the code structure alone.`,
	...
	"init-memory-bank": {
		...
		description: "Initialize AlfaCode Memory Bank for project context management",
		content: `<task>
Initialize the AlfaCode Memory Bank for this project.
This creates a structured knowledge base in .kilocode/memory-bank/ that serves as the "Single Source of Truth" for project context.
</task>

<initialization>
  <purpose>
    Create the Memory Bank directory structure with properly templated files.
    The Memory Bank helps maintain context across sessions and enables better collaboration.
  </purpose>

  <workflow>
    First, ask the user which initialization mode they prefer:

    **Option 1: Automatic (Recommended)**
    - Analyze the codebase (package.json, config files, directory structure)
    - Generate all Memory Bank files with discovered information
    - Fill in what can be detected, leave placeholders for unknowns

    **Option 2: Guided**
    - Ask the user to describe the project briefly (goals, constraints)
    - Generate brief.md from their description
    - Auto-generate remaining files based on codebase analysis

    Use ask_followup_question to let the user choose:
    - "Automatic - analyze codebase and generate files"
    - "Guided - I'll provide project description first"
  </workflow>

  <structure>
    Create .kilocode/memory-bank/ directory with these files:

    1. **index.md** - Navigation and metadata
       \`\`\`markdown
       # Memory Bank
       ...
       ## Quick Start
       1. Read context.md for current focus
       2. Confirm with [MB: OK]

       ## Files
       | File | Purpose | Update When |
       |------|---------|-------------|
       | brief.md | Goals, constraints, DoD | Goals change |
       | product.md | Users, UX, value | Product changes |
       | architecture.md | Design, components | Architecture changes |
       | tech.md | Stack, tools | Stack changes |
       | context.md | Current focus, next steps | After each task |

       ## Metadata
       - **Project:** [PROJECT_NAME]
       - **Phase:** [Development/Maintenance/etc]
       - **Last Updated:** [DATE]
       \`\`\`

    2. **brief.md** - Project goals, constraints, Definition of Done
       - Goals and objectives
       - Constraints and limitations
       - Definition of Done criteria
       - Key stakeholders

    3. **product.md** - User personas, UX flows, value proposition
       - Target users
       - Key features
       - User journeys
       - Value proposition
    ...
    5. **tech.md** - Technology stack, dependencies, tools
       - Languages and frameworks
       - Key dependencies
       - Development tools
       - Build and deployment

    6. **context.md** - Current focus, risks, next steps
       \`\`\`markdown
       ## Current Focus
  ...
  <discovery>
    ...
    - package.json / Cargo.toml / pyproject.toml - for project name, dependencies, scripts
    - README.md - for project description
    - Config files - for tech stack clues
    - Directory structure - for architecture hints
    - Existing .kilocode/ files - preserve and enhance
  </discovery>

  <quality_guidelines>
    - Keep files concise and factual
    - Use information discovered from codebase
    - Don't invent information - use placeholders like [TODO: describe]
    - Include clear update triggers for each file
...
<completion>
  ...
  2. Summarize what was discovered vs what needs manual input
  3. Confirm with: [MB: INITIALIZED]
  4. Suggest next steps (e.g., "Review and update brief.md with your project goals")
</completion>`,
	},
	// kilocode_change end
}
