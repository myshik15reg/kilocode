...
export const DEFAULT_RERANK_CANDIDATE_LIMIT = CODEBASE_INDEX_DEFAULTS.DEFAULT_RERANK_CANDIDATE_LIMIT
export const DEFAULT_RERANK_TOP_K = CODEBASE_INDEX_DEFAULTS.DEFAULT_RERANK_TOP_K
export const DEFAULT_RERANK_TIMEOUT_MS = CODEBASE_INDEX_DEFAULTS.DEFAULT_RERANK_TIMEOUT_MS
export const DEFAULT_RERANK_MODEL_ID = CODEBASE_INDEX_DEFAULTS.DEFAULT_RERANK_MODEL_ID
// kilocode_change end
