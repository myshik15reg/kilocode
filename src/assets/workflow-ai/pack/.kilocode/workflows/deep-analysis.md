# Рабочий процесс: Глубокий анализ кода (deep-analysis)
...
1. Прочитай все файлы из `.kilocode/memory-bank/`:
...
**Действия:**
1. Прочитать все файлы из `.kilocode/memory-bank/`
...
Этот воркфлоу может быть использован:
...
1. Сохраняй отчет в `.protocols/YYYY-MM-DD-name/deep-analysis.md`
...
1. Создай отдельный протокол: `.protocols/YYYY-MM-DD-deep-analysis/` (или другой короткий slug)
2. Сохраняй отчет в `.protocols/YYYY-MM-DD-deep-analysis/deep-analysis.md`
3. Обновляй `.kilocode/memory-bank/context.md` кратким резюме и следующими шагами
4. Для критических проблем - предложи отдельные протоколы на исправление
