...
This directory is the workflow library and source-of-truth for process guidance.

Slash commands are discovered from `.kilocode/commands/`, where thin command entrypoints reference these workflow files.

Documentation standard: [`docs-standards.md`](../rules/docs-standards.md:1).
...
| Operational menu                 | [`quickref.md`](quickref.md:1)                           |
| Initialize or repair Memory Bank | [`init-memory-bank.md`](init-memory-bank.md:1)           |
| Clean task contract              | [`brief-refinement.md`](brief-refinement.md:1)           |
| Shape `Spec` and `Plans`         | [`spec-plans-generation.md`](spec-plans-generation.md:1) |
...
| Troubleshooting          | [`orchestration-troubleshooting.md`](orchestration-troubleshooting.md:1) |

## Quality and security

| Purpose               | Workflow                                                 |
| --------------------- | -------------------------------------------------------- |
| Quality gates (CI/PR) | [`quality-enforcement.md`](quality-enforcement.md:1)     |
| Waiver                | [`waiver-workflow.md`](waiver-workflow.md:1)             |
