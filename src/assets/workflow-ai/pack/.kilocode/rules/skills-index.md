...
Before beginning work, check `~/.kilocode/skills/index.md` (or list the directory) to see what skills are available:
```bash
ls ~/.kilocode/skills/
```
...
- `devcontainer-kilocode/SKILL.md` - Devcontainer bind mounts for KiloCode on Windows
...
- `translation/SKILL.md` - i18n/localization changes (keys/placeholders safety)
...
- `translation/SKILL.md` - Localization safety and consistency
