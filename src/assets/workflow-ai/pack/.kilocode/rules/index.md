...
Purpose: provide stable source-of-truth links without duplicating requirements.
...
| Documentation standards | [`docs-standards.md`](docs-standards.md:1)                             |
...
| Artifact boundary       | [`brief-spec-memory-bank.md`](brief-spec-memory-bank.md:1)             |

## Thin wrappers

Wrappers should stay short and point back to source-of-truth documents.
...
| [`security-rules.md`](security-rules.md:1)             | [`security.md`](../patterns/security/security.md:1)                  |
...
## Mode-specific runtime rules

| Mode         | File                                                                           |
| ------------ | ------------------------------------------------------------------------------ |
| Orchestrator | [`../rules-orchestrator/delegation.md`](../rules-orchestrator/delegation.md:1) |
| Architect    | [`../rules-architect/planning.md`](../rules-architect/planning.md:1)           |
| Code         | [`../rules-code/testing.md`](../rules-code/testing.md:1)                       |
