...
| Нужен свежий snapshot реального состояния репозитория | [`workspace-context-bootstrap.md`](workspace-context-bootstrap.md:1)                                             | Есть `workspace-context.md` и явные assumptions          |
...
| Нужен устойчивый resume через compaction/handoff      | [`session-checkpoint.md`](session-checkpoint.md:1)                                                               | Есть `checkpoint.md` с exact next action                 |
...
| Fresh workspace snapshot                      | `/workspace-context-bootstrap.md`                                      |
| Planner/executor split                        | `/planner-executor.md`                                                 |
| Session checkpoint / resume state             | `/session-checkpoint.md`                                               |
