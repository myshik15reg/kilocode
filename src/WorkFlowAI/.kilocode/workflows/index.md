...
| Purpose                   | Workflow                                             |
| ------------------------- | ---------------------------------------------------- |
| Minimal start corridor    | [`../QUICK.md`](../QUICK.md:1)                       |
...
| Purpose                          | Workflow                                                               |
| -------------------------------- | ---------------------------------------------------------------------- |
| Classify trivial vs non-trivial  | [`../rules/task-classification.md`](../rules/task-classification.md:1) |
| Design discovery before protocol | [`brainstorm-design.md`](brainstorm-design.md:1)                       |
...
| Planner/executor split                     | [`planner-executor.md`](planner-executor.md:1)                           |
| Session checkpoint before resume/handoff   | [`session-checkpoint.md`](session-checkpoint.md:1)                       |
...
| Process inbox notes into durable knowledge | [`notes-inbox-processing.md`](notes-inbox-processing.md:1)               |
...
| Risk-tiered review path       | [`risk-tier-review.md`](risk-tier-review.md:1)                     |
| Agent evaluation lifecycle    | [`agent-evaluation-lifecycle.md`](agent-evaluation-lifecycle.md:1) |
| Workflow eval scenarios       | [`workflow-evals.md`](workflow-evals.md:1)                         |
...
| Purpose                                          | Workflow                                                             |
| ------------------------------------------------ | -------------------------------------------------------------------- |
| Retrieval-first research                         | [`research-retrieval.md`](research-retrieval.md:1)                   |
| Fresh workspace snapshot before planning/handoff | [`workspace-context-bootstrap.md`](workspace-context-bootstrap.md:1) |

## Operations

| Purpose                           | Workflow                                             |
| --------------------------------- | ---------------------------------------------------- |
| Quick diagnosis / triage          | [`quick-diagnosis.md`](quick-diagnosis.md:1)         |
| Incident/hotfix                   | [`hotfix-emergency.md`](hotfix-emergency.md:1)       |
| Deployment                        | [`deployment-workflow.md`](deployment-workflow.md:1) |
| Safety check before risky actions | [`pre-action-check.md`](pre-action-check.md:1)       |
...
| 1C review pack | [`1c-review-pack.md`](1c-review-pack.md:1)           |
