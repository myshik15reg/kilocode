...
This document demonstrates how to run AlfaCode assistant CLI in a Docker container using only environment variables, without requiring a config.json file.
...
# Install AlfaCode assistant CLI globally
...
jobs:
    code-review:
        ...
        steps:
            ...
            - name: Install AlfaCode assistant CLI
              run: npm install -g @kilocode/cli
...
This will run AlfaCode assistant CLI in a completely ephemeral environment without any persistent configuration files.
