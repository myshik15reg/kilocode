...
This directory contains the JetBrains plugin implementation for AlfaCode assistant, including both the IntelliJ plugin (Kotlin) and the Extension Host (Node.js/TypeScript).
