...
class PlusButtonClickAction : AnAction() {
    ...
    private val commandId: String = "alfa-code-assistant.plusButtonClicked"
...
class PromptsButtonClickAction : AnAction() {
    ...
    private val commandId: String = "alfa-code-assistant.promptsButtonClicked"
...
class HistoryButtonClickAction : AnAction() {
    ...
    private val commandId: String = "alfa-code-assistant.historyButtonClicked"
...
class ProfileButtonClickAction : AnAction() {
    ...
    private val commandId: String = "alfa-code-assistant.profileButtonClicked"
...
class SettingsButtonClickAction : AnAction() {
    ...
    private val commandId: String = "alfa-code-assistant.settingsButtonClicked"
...
class MarketplaceButtonClickAction : AnAction() {
    ...
    private val commandId: String = "alfa-code-assistant.marketplaceButtonClicked"
