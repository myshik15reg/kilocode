...
If compilation fails, you can skip WASM compilation and use the generated grammar.json for development. TreeSitterGraphExtractor can work with the parser.c through Node.js bindings.
